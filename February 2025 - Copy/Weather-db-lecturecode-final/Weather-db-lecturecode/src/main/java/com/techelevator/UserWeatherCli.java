...
public class UserWeatherCli {
    ...
    public void getWeatherByUserId(){
        ...
        System.out.println("Date         Zip    Name                  Temp   Feels   Humidity   Desc");
        System.out.println("-------------------------------------------------------------------------------------");
        for (WeatherDto dto: list){
            System.out.printf("%-10s  %6d  %-20s %6.2f %6.2f   %-6d     %-15s \n",
                    dto.getDate().format(DateTimeFormatter.ofPattern("MM/dd/yyyy")),
                    dto.getZipcode(),
                    dto.getName(),
                    dto.getTemperature(),
                    dto.getFeelsLike(),
