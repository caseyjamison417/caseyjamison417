...
public class JdbcNeoDao implements  NeoDao {
    ...
    @Override
    public Neo saveNeo(Neo neo, int userId, Local date) {

        String sql = "INSERT INTO neo (nasa_id, user_id, neo_date, neo_name, hazardous, " +
    ...
    public Neo getNeoById(int id) {
        String sql = "SELECT db_id, nasa_id, nasa_name FROM neo " +
                "WHERE db_id = ?";
